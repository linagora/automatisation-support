import type {
  ...
  StandardCategory,
  StandardRendererInstructionCatalog,
...
const STANDARD_RENDERER_INSTRUCTIONS: StandardRendererInstructionCatalog = {
...
function hasTemplateForCategory<TCategory extends StandardCategory>(
  ...
  return params.standardSubcategory in
    STANDARD_RENDERER_INSTRUCTIONS[params.category];
}
